export default function () {
  return (
    <div class="firstvisit">
      <div class="firstvisit__item">
        <div class="firstvisit__item__text">
          <h4>Частное лицо</h4>
          <p>Чтобы читать найденную книгу, положите её в корзину, выберите удобный способ оплаты и сразу же получите полный доступ</p>
        </div>
        <img src="/src/assets/static/img/firstvisit/1.webp" alt="Заполните меня" class="firstvisit__item__img" />
      </div>
      <div class="firstvisit__item">
        <div class="firstvisit__item__text">
        ...
        <img src="/src/assets/static/img/firstvisit/2.webp" alt="Заполните меня" class="firstvisit__item__img" />
      </div>
      <div class="firstvisit__item">
        <div class="firstvisit__item__text">
        ...
        <img src="/src/assets/static/img/firstvisit/3.webp" alt="Заполните меня" class="firstvisit__item__img" />
      </div>
    </div>
  )
}